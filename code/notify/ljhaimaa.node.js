...
function start(postData, response, query) {
    var fs = require('fs');
    fs.appendFile('payOrder.log', "ljhaimaa:" + jutil.now() + " | " + JSON.stringify(postData) + "\n" + JSON.stringify(query) + "\n", 'utf8');
    console.log("ljhaimaa...POST...." + JSON.stringify(postData));
    console.log("ljhaimaa...GET...." + JSON.stringify(query));
    ...
    var appKey = platformConfig["ljhaimaa"]["appKey"];
    ...
    if (sign != md5Sign) {
        ...
        order.updateOrder(args[0], out_trade_no, "ljhaimaa", args[1], args[2], total_fee, 1, "", args[3],JSON.stringify(postData), function (err, res) {
            if (res == 1) {
