...
function start(postData, response, query) {
    var NAME = "gm";
    fs.appendFile('payOrder.log', NAME + "vipLevel:" + jutil.now() + " | " + JSON.stringify(postData) + "\n" + JSON.stringify(query) + "\n", 'utf8');
    console.log(NAME + "...POST...." + JSON.stringify(postData));
    console.log(NAME + "...GET...." + JSON.stringify(query));
    if (jutil.postCheck(query, "user", "server_id", "sign", "vip", "exp") == false) {
    ...
    var signStr = vip + "" + exp + "" + server_id + "" + userId + "" + key;
