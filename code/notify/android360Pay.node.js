...
function start(postData, response, query) {
    ...
    var sortArr = [];
    var sign_str = "";
    obj["appKey"] = query["appKey"]; //应用appkey
    ...
    var app_secret = platformConfig["360"]["app_secret"];
    for(var key in obj){
    ...
    if (sign != md5Sign) {
        ...
        order.updateOrder(obj["app_uid"], obj["order_id"], "360", obj["user_id"], "", Math.floor(obj["amount"] / 100), 1, "", obj["product_id"], JSON.stringify(query), function (err, res) {
            if (res == 1)
