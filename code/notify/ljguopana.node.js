...
function start(postData, response, query) {
    var fs = require('fs');
    fs.appendFile('payOrder.log', "ljguopana:" + jutil.now() + " | " + JSON.stringify(postData) + "\n" + JSON.stringify(query) + "\n", 'utf8');
    console.log("ljguopana...POST...." + JSON.stringify(postData));
    console.log("ljguopana...GET...." + JSON.stringify(query));
    ...
    var appSecret = platformConfig["ljguopana"]["appSecret"];
    ...
    if (sign != md5Sign) {
        ...
        order.updateOrder(reserved, serialNumber, "ljguopana", "", "", money, 1, "", "",JSON.stringify(postData), function (err, res) {
            if (res == 1) {
