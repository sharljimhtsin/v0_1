/**
 * Created by xiazhengxin on 2015/7/17 17:20.
 */
...
var TAG = "modifier.react";

function start(postData, response, query) {
    if (jutil.postCheck(postData, "skillUid", "index") == false) {
    ...
    async.series([function (cb) {
        ...
        modifierData.setSkill(userUid, skillUid, data, cb);
    }, function (cb) {
