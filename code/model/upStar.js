...
function getStarData(userUid, cb) {
    activityData.getActivityData(userUid, activityData.UPSTAR, function (err, res) {
        var obj;
        var jsonObj;
        if (res["arg"] == "") {
            obj = null;
...
function setStarData(userUid, data, cb) {
    ...
    activityData.updateActivityData(userUid, activityData.UPSTAR, mObj, cb);
}
