...
Connection.prototype.query = function(sql, values, cb) {
  ...
  console.log("111111111111111111",query._connection._pool._allConnections.length);
  ...
  console.log("22222222222222",query._connection._pool._allConnections.length);
